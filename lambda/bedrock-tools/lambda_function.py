...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Handle Bedrock access issues with fallback response
        if ('ValidationException' in error_code or 
            'Access to Anthropic models is not allowed' in error_message or
            "You don't have access to the model" in error_message):
